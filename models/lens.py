...
class Lens(BaseSQLModel, table=True):
    ...
    model: str = Field(sa_column=sa.Column(sa.String(100)))
    model_zh: Optional[str] = Field(sa_column=sa.Column(sa.String(100)), default=None)
    ...
    focal_length: Optional[str] = Field(sa_column=sa.Column(sa.String(50)), default=None)
    aperture_range: Optional[str] = Field(sa_column=sa.Column(sa.String(50)), default=None)
    mount_id: Optional[int] = Field(default=None, foreign_key="mount.id")
    lens_type: Optional[str] = Field(sa_column=sa.Column(sa.String(50)), default=None)
    ...
    dimensions: Optional[str] = Field(sa_column=sa.Column(sa.String(50)), default=None)
